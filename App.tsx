          ...
          <div className="space-y-6">
            ...
            <div className="relative">
              ...
              <button 
                ...
                className={`absolute bottom-4 right-4 p-3 rounded-xl shadow-2xl transition-all ${
                  isGenerating ? 'bg-slate-100' : 'bg-[#0077C8] text-white hover:scale-105 active:scale-90'
                }`}
              >
                {isGenerating ? (
              ...
              {deck.map((s, i) => (
                <button
                  ...
                  className={`w-full flex items-center gap-4 p-4 rounded-2xl border transition-all text-left shadow-sm ${
                    currentSlideIndex === i ? 'border-[#0077C8] bg-blue-50 ring-2 ring-blue-500/10' : 'border-slate-100 bg-white'
                  }`}
                >
